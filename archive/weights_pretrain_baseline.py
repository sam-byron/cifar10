...
x = transpose_res_block(x, 448+MODIFIER, 2, strides=1, dropout=DROPOUT)

x = transpose_res_block(x, 384+MODIFIER, 2, strides=2, dropout=DROPOUT)

x = transpose_res_block(x, 320+MODIFIER, 2, strides=2, dropout=DROPOUT)

x = transpose_res_block(x, 256+MODIFIER, 2, strides=1, dropout=DROPOUT)

x = transpose_res_block(x, 192+MODIFIER, 2, strides=2, dropout=DROPOUT)

x = transpose_res_block(x, 128+MODIFIER, 2, strides=1, dropout=DROPOUT)

x = transpose_res_block(x, 64+MODIFIER, 2, strides=2, dropout=DROPOUT)
