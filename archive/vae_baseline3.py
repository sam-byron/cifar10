...
x = layers.Conv2D(196, 3, activation="relu", strides=2, padding="same", kernel_initializer=initializer)(x)

x = layers.Conv2D(350, 3, activation="relu", strides=1, padding="same", kernel_initializer=initializer)(x)

x = layers.Conv2D(750, 3, activation="relu", strides=2, padding="same", kernel_initializer=initializer)(x)

x = layers.Conv2D(1024, 3, activation="relu", strides=1, padding="same", kernel_initializer=initializer)(x)
...
x = layers.Conv2DTranspose(1024, 3, activation="relu", strides=2, padding="same", kernel_initializer=initializer)(x)

x = layers.Conv2DTranspose(750, 3, activation="relu", strides=1, padding="same", kernel_initializer=initializer)(x)

x = layers.Conv2DTranspose(350, 3, activation="relu", strides=1, padding="same", kernel_initializer=initializer)(x)

x = layers.Conv2DTranspose(196, 3, activation="relu", strides=2, padding="same", kernel_initializer=initializer)(x)
